...
contract NftOffers is Ownable {
    ...
    function createNftOffer(uint256 _tokenId, uint256 _nftPrice, address _seller) external onlyOwner {
    ...
    function acceptOffer(uint256 _tokenId) public payable {
        ...
        nonFungibleContract.safeTransferFrom(msg.sender, offer.highestBidder, _tokenId);
    ...
    function _setOffer(uint256 _tokenId, uint256 offer) private {
        ...
        indexOfofferBidsFromTokenId[_tokenId][msg.sender] = addressesFromTokenId[_tokenId].length;
