            ...
            {cask.isLoading || cask.isValidating ? (
              ...
              <>
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 px-4">
                  <div className="flex items-center p-2 bg-caskchain mb-4 rounded-lg">
                    <h1 className="text-7xl font-semibold text-blackLight">
                      NFT DETAILS
                    </h1>
                  </div>
                      ...
                      <div className="grid grid-cols-2 mt-6">
                        {cask?.data?.meta?.attributes?.map((attribute: any) => (
                          ...
                          >
                            ...
                            <dd className="order-1 text-3xl font-extrabold text-caskchain">
                              {attribute.value}
                            </dd>
                          </div>
                        ))}
